...
export function QA() {
  ...
  const getLocalizedData = () => {
    switch (i18n.language) {
      case "ja":
        return {
          QAData: QADataJa,
          StudyRequirements: StudyRequirementsJa,
          JapanPreparation: JapanPreparationJa,
        };
      case "en":
        return {
          QAData: QADataEn,
          StudyRequirements: StudyRequirementsEn,
          JapanPreparation: JapanPreparationEn,
        };
      default:
        return {
          QAData,
  ...
  const {
    QAData: localizedQAData,
    StudyRequirements: localizedStudyRequirements,
    JapanPreparation: localizedJapanPreparation,
  } = getLocalizedData();
    ...
    <div className="relative flex flex-col w-fulls pl-[20px] pr-[70px] md:px-20 lg:px-[156px] pb-[100px] pt-[100px]">
      ...
      {i18n.language === "zh" && (
        <div className="md:hidden  fixed top-[166px] right-[20px] flex flex-col gap-[100px] w-[20px] text-nowrap z-[10] overflow-visible">
          ...
          {/* 侧边栏 */}
          <div className="flex flex-col justify-start gap-[70px] items-center font-normal text-nowrap ">
            <div
              className={`rotate-90 w-[55px] text-[12px] tracking-[1.12px] relative ${
                activeSection === "frzb"
                  ? "after:scale-x-100"
                  : "after:scale-x-0"
            ...
            <div
              className={`rotate-90 w-[66px] text-[12px] tracking-[1.12px] inline-block relative ${
                activeSection === "xxxzy"
                  ? "after:scale-x-100"
                  : "after:scale-x-0"
              } after:content-[''] after:absolute after:-bottom-[1px] after:left-0 after:w-full after:h-[1px] after:bg-black after:transition-transform after:duration-300 after:scale-x-0 after:origin-left`}
            ...
            <div
              className={`rotate-90 text-[12px]  mt-[40px] tracking-[1.12px] inline-block relative ${
                activeSection === "xbdxy"
                  ? "after:scale-x-100"
                  : "after:scale-x-0"
              } after:content-[''] after:absolute after:-bottom-[1px] after:left-0 after:w-full after:h-[1px] after:bg-black after:transition-transform after:duration-300 after:scale-x-0 after:origin-left`}
      ...
      {localizedJapanPreparation.map((item) => (
        <QAcomponent
      ...
      {localizedStudyRequirements.map((item) => (
        <QAcomponent question={item.question} answer={item.answer} />
      ))}
    </div>
  );
