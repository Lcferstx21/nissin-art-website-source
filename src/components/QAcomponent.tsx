...
export function QAcomponent({ question, answer, link }: QAcomponentProps) {
      ...
      <div className=" md:px-[95px] flex flex-col relative">
        ...
        {isToggled && (
          <div className="flex flex-col">
            <div className="whitespace-pre-line pl-[50px] md:px-[96px] pt-[60px] pb-[30px] text-[14px] tracking-[1.5px] md:text-[15px] font-normal text-black leading-[25px] md:tracking-[1px] text-justify">
              {answer}
              {link && (
                <a
                  href={link}
